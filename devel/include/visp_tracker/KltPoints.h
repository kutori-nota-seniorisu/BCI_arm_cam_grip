...
struct KltPoints_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::visp_tracker::KltPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::visp_tracker::KltPoint_<ContainerAllocator> >> _klt_points_positions_type;

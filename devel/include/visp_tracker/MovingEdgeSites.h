...
struct MovingEdgeSites_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::visp_tracker::MovingEdgeSite_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::visp_tracker::MovingEdgeSite_<ContainerAllocator> >> _moving_edge_sites_type;

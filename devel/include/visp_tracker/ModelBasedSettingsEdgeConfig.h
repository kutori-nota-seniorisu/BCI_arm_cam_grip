...
namespace visp_tracker
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ModelBasedSettingsEdgeConfig &config, const ModelBasedSettingsEdgeConfig &max, const ModelBasedSettingsEdgeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ModelBasedSettingsEdgeConfig &config1, const ModelBasedSettingsEdgeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ModelBasedSettingsEdgeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ModelBasedSettingsEdgeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ModelBasedSettingsEdgeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ModelBasedSettingsEdgeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ModelBasedSettingsEdgeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ModelBasedSettingsEdgeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);

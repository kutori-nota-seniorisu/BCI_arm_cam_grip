...
bool operator==(const ::visp_hand2eye_calibration::compute_effector_camera_quickRequest_<ContainerAllocator1> & lhs, const ::visp_hand2eye_calibration::compute_effector_camera_quickRequest_<ContainerAllocator2> & rhs)
{
  return lhs.camera_object == rhs.camera_object &&
    lhs.world_effector == rhs.world_effector;
}
...
struct Definition< ::visp_hand2eye_calibration::compute_effector_camera_quickRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This service computes the effector to camera transformation from \n"

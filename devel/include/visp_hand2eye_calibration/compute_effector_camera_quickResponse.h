...
bool operator==(const ::visp_hand2eye_calibration::compute_effector_camera_quickResponse_<ContainerAllocator1> & lhs, const ::visp_hand2eye_calibration::compute_effector_camera_quickResponse_<ContainerAllocator2> & rhs)
{

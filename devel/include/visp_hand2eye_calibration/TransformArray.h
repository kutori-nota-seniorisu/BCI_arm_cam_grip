...
bool operator==(const ::visp_hand2eye_calibration::TransformArray_<ContainerAllocator1> & lhs, const ::visp_hand2eye_calibration::TransformArray_<ContainerAllocator2> & rhs)
{

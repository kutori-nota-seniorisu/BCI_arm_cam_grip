...
struct CalibPointArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::visp_camera_calibration::CalibPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::visp_camera_calibration::CalibPoint_<ContainerAllocator> >> _points_type;
  _points_type points;

...
struct calibrateResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _stdDevErrs_type;
...
bool operator==(const ::visp_camera_calibration::calibrateResponse_<ContainerAllocator1> & lhs, const ::visp_camera_calibration::calibrateResponse_<ContainerAllocator2> & rhs)
{
  return lhs.stdDevErrs == rhs.stdDevErrs;
}

...
struct ImageAndPoints_
{
  ...
  _image_type image;
   ...
   typedef std::vector< ::visp_camera_calibration::ImagePoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::visp_camera_calibration::ImagePoint_<ContainerAllocator> >> _points_type;
  _points_type points;
...
bool operator==(const ::visp_camera_calibration::ImageAndPoints_<ContainerAllocator1> & lhs, const ::visp_camera_calibration::ImageAndPoints_<ContainerAllocator2> & rhs)
{

...
class compute_effector_camera_quickRequest(genpy.Message):
  ...
  _full_text = """# This service computes the effector to camera transformation from 
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.camera_object.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.world_effector.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:

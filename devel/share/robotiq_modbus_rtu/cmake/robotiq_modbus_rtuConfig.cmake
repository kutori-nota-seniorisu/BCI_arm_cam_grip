...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/sd/BCI_arm_cam_grip/src/robotiq/robotiq_modbus_rtu)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sd/BCI_arm_cam_grip/src/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()

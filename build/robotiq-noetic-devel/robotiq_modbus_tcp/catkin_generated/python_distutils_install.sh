...
echo_and_run cd "/home/sd/BCI_arm_cam_grip/src/robotiq-noetic-devel/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sd/BCI_arm_cam_grip/src/robotiq-noetic-devel/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/sd/BCI_arm_cam_grip/build/robotiq-noetic-devel/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
